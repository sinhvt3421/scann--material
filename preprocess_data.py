...
def main(args):
    ...
    init_dataset(args.dataset, args.dataset_path, args.save_path, args.dt, args.wt, args.p)
...
if __name__ == "__main__":
    ...
    parser.add_argument('dataset_path', type=str, default='experiments/fullerence',
